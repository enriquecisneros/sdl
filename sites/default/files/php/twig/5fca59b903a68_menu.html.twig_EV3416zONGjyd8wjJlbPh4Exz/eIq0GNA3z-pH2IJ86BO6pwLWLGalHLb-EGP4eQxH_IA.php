...
/* menu.html.twig */
class __TwigTemplate_930d6dd1ad31cdef286cfa249aacd466c48baecf8f857ea6033874158ae55c2f extends \Twig\Template
{
...
";
        // line 60
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->sandbox->ensureToStringAllowed($this->getAttribute($this, "menu_links", [0 => ($context["items"] ?? null), 1 => ($context["attributes"] ?? null), 2 => 0, 3 => ((($context["classes"] ?? null)) ? (($context["classes"] ?? null)) : ([0 => ("" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["menu_name"] ?? null)))), 1 => ""])), 4 => ((($context["dropdown_classes"] ?? null)) ? (($context["dropdown_classes"] ?? null)) : ([0 => ""]))], "method")));
        echo "
";
    }
...
$context["item"], "is_expanded", []) && $this->getAttribute($context["item"], "below", []))) ? ("expanded ") : ("")), 1 => (($this->getAttribute(                    // line 32
...
$context["loop"], "last", [])) ? ("last") : (""))];
        ...
        ";
                    ...
                    if ((((($context["menu_level"] ?? null) == 0) && $this->getAttribute($context["item"], "is_expanded", [])) && $this->getAttribute($context["item"], "below", []))) {
                        ...
                        // line 42
                        echo "          ";
                        $context["link_attributes"] = $this->getAttribute($this->getAttribute(($context["link_attributes"] ?? null), "addClass", [0 => ""], "method"), "setAttribute", [0 => "", 1 => ""], "method");
                        // line 43
                        echo "        ";
                    }
                    // line 44
  ...
  ";
    ...
    {
        return new Source("", "menu.html.twig", "themes/sdol/templates/menu.html.twig");
    }
